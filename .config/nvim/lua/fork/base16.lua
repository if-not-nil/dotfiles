...
H.apply_palette = function(palette, use_cterm)
  ...
  hi('ColorColumn', { fg = nil, bg = nil, attr = nil, sp = nil })
  ...
  hi('CursorColumn', { fg = nil, bg = nil, attr = nil, sp = nil })
  ...
  hi('LineNr', { fg = p.base04, bg = nil, attr = nil, sp = nil })
  ...
  hi('TabLine', { fg = p.base03, bg = nil, attr = nil, sp = nil })
  hi('TabLineFill', { fg = p.base03, bg = nil, attr = nil, sp = nil })
  hi('TabLineSel', { fg = p.base0B, bg = nil, attr = nil, sp = nil })
  ...
  hi('Number', { fg = p.base09, bg = p.base00, attr = nil, sp = nil })
  ...
  if H.has_integration('echasnovski/mini.nvim') then
    ...
    hi('MiniTablineHidden', { fg = p.base04, bg = nil, attr = nil, sp = nil })
    hi('MiniTablineModifiedCurrent', { fg = p.base02, bg = p.base05, attr = 'bold', sp = nil })
    hi('MiniTablineModifiedHidden', { fg = p.base07, bg = p.base01, attr = nil, sp = nil })
