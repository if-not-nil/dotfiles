...
return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<space>pc", dap.continue, { desc = "Debug: Continue" })
			vim.keymap.set("n", "<space>ps", dap.step_over, { desc = "Debug: Step Over" })
			vim.keymap.set("n", "<space>pi", dap.step_into, { desc = "Debug: Step Into" })
			vim.keymap.set("n", "<space>po", dap.step_out, { desc = "Debug: Step Out" })
			vim.keymap.set("n", "<space>pb", dap.toggle_breakpoint, { desc = "Debug: Toggle Breakpoint" })
